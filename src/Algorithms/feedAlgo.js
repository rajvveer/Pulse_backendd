...
const CONFIG = {
    HALF_LIFE_HOURS: 12, MAX_AGE_HOURS: 72,
    ...
    SESSION_PACING: { EARLY_BOOST: 1.5, MID_DIP: 0.85, LATE_SPIKE: 1.3, EARLY_THRESHOLD: 5, MID_THRESHOLD: 15 },
    SOCIAL_PROOF: { FRIEND_LIKE_BOOST: 0.8, MAX_FRIEND_BOOST: 3.0, MIN_FRIENDS_SHOW: 2 },
    CURIOSITY: { INJECTION_RATE: 0.1, TRENDING_BOOST: 2.0, CONTROVERSIAL_BOOST: 1.5 },
    FRESHNESS: { NEW_CONTENT_BOOST: 1.4, SEEN_PENALTY: 0.3 },
    // v2 additions
